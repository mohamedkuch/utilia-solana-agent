...
npx -y utilia-solana-agent@0.5.5 audio-normalize \
...
export SOLANA_KEYPAIR_PATH=/absolute/path/to/automation-wallet.json
npx -y utilia-solana-agent@0.5.5 doctor
npx -y utilia-solana-agent@0.5.5 pdf-to-markdown https://example.com/document.pdf
```
...
npx -y utilia-solana-agent@0.5.5 audio-normalize <public-https-audio-url> [--output normalized.mp3] [--target-lufs -16] [--max-seconds 180]
npx -y utilia-solana-agent@0.5.5 pdf <public-https-pdf-url> [max-pages]
npx -y utilia-solana-agent@0.5.5 pdf-to-markdown <public-https-pdf-url> [--max-pages 50]
